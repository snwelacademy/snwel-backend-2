...
const dashboardController = __importStar(require("../../controllers/admin/dashboardController"));
const router = (0, express_1.Router)();
exports.AdminDashboardRouter = router;
router.use(passport_1.default.authenticate('jwt', { session: false }));
router.use((0, permissionMiddleware_1.checkPermission)('ANALYTICS_VIEW'));
